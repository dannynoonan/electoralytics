    ...
    dbc.CardBody([
        ...
        dbc.Nav(className="nav nav-pills", children=[
            ...
            dbc.DropdownMenu(label="Visualizing Jim Crow voter suppression", nav=True, children=[
                ...
                dbc.DropdownMenuItem([html.I(className="fa"), "Part 1: Electoral College basics: Equality for states, not for voters"], href='/voter-weight-electoral-college-bias-page1', target="_blank"), 
                ...
                dbc.DropdownMenuItem([html.I(className="fa"), "Part 5: Discussion and conclusions"], href='/voter-weight-conclusions', target="_blank"), 
