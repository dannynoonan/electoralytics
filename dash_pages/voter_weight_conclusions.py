                        ...
                        dbc.CardBody([
                            html.Div(className="card-text", style={"margin-left": "50px", "margin-right": "50px", "font-size": "13pt"}, children=[
                                html.P(style={"font-style": "italic"}, children=[
                                    ...
                                    dcc.Link(href="/sources-notes", children=[html.Sup("25")]),
                                ]),
                            ...
                            html.P(className="card-text", children=[
                                ...
                                the institution of slavery.", dcc.Link(href="/sources-notes", children=[html.Sup("26")])
                            ]),
                            html.P(className="card-text", children=[
                            ...
                            html.P(className="card-text", children=[
                                ...
                                the reduction clause of the Fourteenth Amendment has never been enforced,", dcc.Link(href="/sources-notes", children=[html.Sup("27")]), 
                            ...
                            html.P(className="card-text", children=[
                                ...
                                html.Ul([
                                    ...
                                    html.Li(children=["Slave states sent one-third more representatives to Congress than they would have if representation were \
                                        based only on the number of free citizens", dcc.Link(href="/sources-notes", children=[html.Sup("29")])
                                    ]),
                                ])
                            ]),
                            ...
                            html.P(className="card-text", children=[
                                ...
                                dcc.Link(href="/sources-notes", children=[html.Sup("29")]),
                                html.Ul([
                        ...
                        dbc.CardBody([
                            html.Div(className="card-text", style={"margin-left": "50px", "margin-right": "50px", "font-size": "13pt"}, children=[
                                html.P(style={"font-style": "italic"}, children=[
                                    ...
                                    dcc.Link(href="/sources-notes", children=[html.Sup("32")]),
                                ]),
                            ...
                            html.P(className="card-text", children=[
                                ...
                                Senate.", dcc.Link(href="/sources-notes", children=[html.Sup("33")]),
                            ]),
                            ...
                            html.P(className="card-text", children=[
                                ...
                                the Senator’s legacy of white supremacy and legislative obstructionism.", dcc.Link(href="/sources-notes", children=[html.Sup("34")]), 
                                ...
                                html.Ul([
                                    html.Li(children=["Segregated neighborhoods carving up nearly every American city today trace back overwhelmingly to the ",
                                        ...
                                        redlining and lending practices beginning in the 1930s,", dcc.Link(href="/sources-notes", children=[html.Sup("35")]), 
                                        ...
                                        dcc.Link(href="/sources-notes", children=[html.Sup("36")]), " These government-imposed impediments to building personal and \
                                    ...
                                    html.Li(children=["The present day exclusion of agricultural, food service, and domestic workers from minimum wage, \
                                        unemployment, and other New Deal-era benefits and protections,", dcc.Link(href="/sources-notes", children=[html.Sup("37")]),
                                        " and even modern-day tipping in lieu of proper workplace compensation,", dcc.Link(href="/sources-notes", 
                                        children=[html.Sup("38")]), " derive from Southern politicians and racially-exploitative entrepreneurs seeking to minimize \
                                        wages for Black labor in the Jim Crow South.", dcc.Link(href="/sources-notes", children=[html.Sup("39")])
                                    ]),                  
