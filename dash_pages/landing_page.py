...
content = html.Div([
    ...
    dbc.Card(className="border-primary bg-success", children=[
        dbc.CardBody([
            html.Br(),
            dbc.Card(className="bg-white border-success", children=[
                dbc.CardBody([
                    dbc.Row([
                        dbc.Col(md=6, children=[
                            ...
                            html.Br(),
                            html.P(className="text-primary", children=[
                            ...
                            html.H5(className="text-primary", children=[
                                            ...
                                            dbc.Collapse(id="collapse-1", children=[
                                                dcc.Link(href="/voter-weight-timeline-visualization", children=[
                                                    html.P(className="text-white", children=[
                                                        "A line chart plotting Voter Weight as a function of time from 1800 to 2020 »"
                                                    ]),
                                        ...
                                        html.A(className="list-group-item list-group-item-action flex-column align-items-start bg-success", children=[
                                            ...
                                            dbc.Collapse(id="collapse-3", children=[
                                                dcc.Link(href="/voter-weight-conclusions", children=[
                                                    html.P(className="text-white", children=[
                                                        "Interpretation of results, as humbly expressed by a non-historian / non-mathematician »"
                                                    ]),
                                                ]),       
                                            ]),
                                        ]),
                ...
                dbc.CardBody([
                    dbc.Row([
                        dbc.Col(md=6, children=[
                            ...
                            html.P(className="text-white", children=[
                                "An ", html.U(children=[dcc.Link("October 2020 episode", href="https://www.npr.org/2020/09/30/918717270/the-electoral-college", 
                                target="_blank", className="text-white")]), " of ", html.I("NPR’s Throughline"), " delved into one such manipulation, \
                                framing disenfranchisement efforts in the Jim Crow South as a “five-fiths” variation on the Constitution’s original \
                                three-fifths slave-tabulating logic. In a year of fresh perspectives on racial justice history, not only did this thrust \
                                the remote, anachronistic history of the three-fifths compromise onto the doorstep of the very recent past, it also prompted \
                                me to wonder: is there a uniform way to quantify the relative fairness, inequity, or bias enjoyed/exploited by any given \
                                state, in any given election?"
                            ]),
                            html.P(className="text-white", children=[
                                "I took a stab at unearthing any scholarly metrics on the topic and came up empty, so I forged ahead with my own amateur \
                                mathing. Using a simple, generic formula, aided by python data processing and visualization tools, I’ve attempted an \
